...
export const itemImprovementAvailabilityFacts = pgTable(
  ...
  (table) => [uniqueIndex('item_improvement_availability_facts_key_unique').on(table.key)],
)
...
export const itemImprovementCostFacts = pgTable(
  ...
  (table) => [uniqueIndex('item_improvement_cost_facts_key_unique').on(table.key)],
)
...
export const itemImprovementUpdateFacts = pgTable(
  ...
  (table) => [uniqueIndex('item_improvement_update_facts_key_unique').on(table.key)],
)
